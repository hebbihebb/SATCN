...
_cached_tool: tuple[object, str] | None = None
...
def _build_language_tool(logger: logging.Logger | None = None):
...
def get_language_tool(logger: logging.Logger | None = None, force_refresh: bool = False):
