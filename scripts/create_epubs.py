...
def create_epub(title, author, content, file_path):
    ...
    c1.content = "<html><body><h1>Chapter 1</h1><p>%s</p></body></html>" % content
    book.add_item(c1)
...
if __name__ == "__main__":
    create_epub("Small Epub", "Jules", "This is a small EPUB document.", "corpus/small.epub")
    create_epub(
        "Medium Epub",
        "Jules",
    ...
    create_epub(
        "Large Epub",
        "Jules",
        "This is a large EPUB document. It has a lot of content to test the performance of the pipeline."
        * 50,
        "corpus/large.epub",
    )
