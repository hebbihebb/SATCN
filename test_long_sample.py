...
def main():
    ...
    # Read document
    with open("tools/test_long.md", 'r', encoding='utf-8') as f:
        content = f.read()
    ...
    novel_words = 90000
    print(f"  Novel ({novel_words:,} words): {(novel_words/words_per_min):.1f} minutes ({(novel_words/words_per_min)/60:.1f} hours)")
